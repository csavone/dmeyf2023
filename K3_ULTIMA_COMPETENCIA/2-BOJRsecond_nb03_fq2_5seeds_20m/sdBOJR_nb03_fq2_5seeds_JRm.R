...
PARAM$experimento <- "sdBOJR_nb03_fq2_5seeds_20m" 
...
PARAM$input$training <- c( 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912,
                           202001, 202002, 202011, 202012,
                           202101, 202102, 202103, 202104, 202105, 202106, 202107) #sin marzo/mayo/oct2020 por experimentos y sin pandemia por JR
...
PARAM$finalmodel$num_iterations <- 1321
PARAM$finalmodel$learning_rate <- 0.0416871341861164
PARAM$finalmodel$feature_fraction <- 0.8
PARAM$finalmodel$min_data_in_leaf <- 1217
PARAM$finalmodel$num_leaves <- 20
