...
PARAM$experimento <- "ftBOJR_nb03_fq2_5seeds_20m" 
...
PARAM$finalmodel$num_iterations <- 601
PARAM$finalmodel$learning_rate <- 0.0619195674126968
PARAM$finalmodel$feature_fraction <- 0.8
PARAM$finalmodel$min_data_in_leaf <- 8382
