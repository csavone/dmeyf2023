...
PARAM$finalmodel$learning_rate <- 0.0813163665768518
PARAM$finalmodel$feature_fraction <- 0.504979823610023
PARAM$finalmodel$min_data_in_leaf <- 6299
PARAM$finalmodel$num_leaves <- 904
