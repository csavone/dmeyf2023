...
#CS: CAMBIOS DEL ORIGINAL: mis 2 semillas, undersampling=0.1
...
PARAM$experimento <- "K3823_BO_2"

PARAM$input$dataset <- "./datasets/competencia_03.csv.gz"

# los meses en los que vamos a entrenar
#  mucha magia emerger de esta eleccion
PARAM$input$testing <- c(202107) #CS:probar mitad e mes en val y mitad en test
PARAM$input$validation <- c(202106)
PARAM$input$training <- c(202003, 202004, 202006, 202008, 
                          202009, 202011, 202012, 202001, 
                          202002, 202003, 202004, 202105)

# un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$undersampling <- 1
PARAM$trainingstrategy$semilla_azar <- 729191 # Aqui poner su  primer  semilla

PARAM$hyperparametertuning$POS_ganancia <- 273000
PARAM$hyperparametertuning$NEG_ganancia <- -7000

# Aqui poner su segunda semilla
PARAM$lgb_semilla <- 729199
#------------------------------------------------------------------------------
...
dataset[ , paste0(col_para_lags, "_lag6") := shift(.SD, 6, type='lag'),  by= numero_de_cliente, .SDcols= col_para_lags]   
